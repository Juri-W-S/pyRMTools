...
def xcor(t1, y1, t2, y2, tlagmin, tlagmax, tunit, imode=SimConfig.xcor['imode']):
    '''
...
def peakcent(t1, y1, t2, y2, tlagmin, tlagmax, tunit, thres=SimConfig.peakcent['thres'], siglevel=SimConfig.peakcent['siglevel'], imode=SimConfig.peakcent['imode'], sigmode = SimConfig.peakcent['sigmode']):
    '''
